...
const GRANT = {
  ...
  sentence:
    "144 months' imprisonment; three years' supervised release; $17,270,741.57 restitution",
  sentenceParsed: {
...
const TIMELINE = [
  {
    date: "Jun 2019",
    event: "Indicted on federal charges in the Northern District of Georgia",
  },
  { date: "Jun 2022", event: "Found guilty by a federal jury on all counts" },
  {
    date: "Nov 2022",
    event: "Sentenced to 144 months' imprisonment and $17.2M restitution",
  },
  { date: "Jan 2024", event: "Reported to FPC Pensacola to begin sentence" },
  {
    date: "May 28, 2025",
    event: "Granted full presidential pardon",
    highlight: true,
  },
];
...
export default function PardonedDetail() {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ maxWidth: 880, margin: "0 auto", padding: "40px 40px 80px" }}
      >
        {/* Breadcrumb */}
        <div
          style={{
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 15, color: "#7A7870", margin: "0 0 24px" }}>
            {GRANT.districtShort} &middot; Sentenced{" "}
            {GRANT.sentenceParsed.sentencingDate}
          </p>
          ...
          >
            ...
            >
              ...
              >
                {GRANT.sentenceParsed.restitution}
              </div>
              <div style={{ fontSize: 12, color: "#9A9890", marginTop: 4 }}>
                Owed to defrauded banks
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                {GRANT.offenses.length}
              </div>
              <div style={{ fontSize: 12, color: "#9A9890", marginTop: 4 }}>
                Including 5 counts of bank fraud
              </div>
            </div>
          </div>
        </div>
          ...
          {["overview", "offenses", "timeline", "related"].map((tab) => (
            <button
              ...
              style={{
                ...
                padding: "12px 24px",
                fontSize: 14,
                color: activeTab === tab ? "#1A1918" : "#9A9890",
                borderBottom:
                  activeTab === tab
                    ? "2px solid #C23B22"
                ...
                {Object.entries(GRANT.sentenceParsed).map(([key, val]) => (
                  <div key={key}>
                    ...
                    <div
                      style={{
                        fontSize: 15,
                        color: key === "restitution" ? "#C23B22" : "#1A1918",
                        fontWeight: key === "restitution" ? 500 : 400,
                      }}
                    >
                      {val}
                    </div>
        ...
        {activeTab === "offenses" && (
          <div>
            <p style={{ fontSize: 14, color: "#7A7870", marginBottom: 24 }}>
              Federal charges for which clemency was granted, as listed on the
              DOJ warrant document.
            </p>
              ...
              {GRANT.offenses.map((o, i) => (
                <div
                  ...
                  style={{
                    ...
                    background: "#FFFFFF",
                    border: "1px solid #E8E6E0",
                    borderLeft: "3px solid rgba(194,59,34,0.35)",
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: "#9A9890" }}>
                      {o.includes("bank fraud") && o.includes("five")
                        ? "Five separate counts"
                        : o.includes("Conspiracy")
            ...
            <div
              style={{
                marginTop: 24,
                padding: "16px 20px",
                background: "rgba(138,107,30,0.05)",
                border: "1px solid rgba(138,107,30,0.15)",
                borderRadius: 8,
                fontSize: 13,
                color: "#7A6A30",
                lineHeight: 1.5,
            ...
            {TIMELINE.map((t, i) => (
              ...
              >
                ...
                <div
                  style={{
                    fontSize: 15,
                    color: t.highlight ? "#1A1918" : "#5A5850",
                    fontWeight: t.highlight ? 500 : 400,
                  }}
                >
                  {t.event}
                </div>
          ...
          <div>
            ...
            {RELATED.map((r, i) => (
              ...
              >
                ...
                <p
                  style={{ fontSize: 13, color: "#6A6860", margin: "0 0 10px" }}
                >
                  {r.offense}
                </p>
                <div
